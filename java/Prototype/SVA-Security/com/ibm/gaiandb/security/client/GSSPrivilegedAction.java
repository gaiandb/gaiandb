...
public class GSSPrivilegedAction implements PrivilegedAction<byte[]> {

//	Use PROPRIETARY notice if class contains a main() method, otherwise use COPYRIGHT notice.
	public static final String COPYRIGHT_NOTICE = "(c) Copyright IBM Corp. 2012";

	private static final Logger logger = new Logger( "GSSPrivilegedAction", 30 );
	
	private static final String GSSMAN_NAME = "gaianClient";
	private static final String GSSSERVICE_NAME = "http@gaiandb.securedom.local";
	
	/**
	 * Connects using the credentials given
	 * @return byte[] byte array containing the secure token
	 */
	public byte[] run() {
